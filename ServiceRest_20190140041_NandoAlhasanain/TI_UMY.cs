...
namespace ServiceRest_20190140041_NandoAlhasanain
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-5TIILIC\\NANDO;Initial Catalog=TI_UMY;Persist Security Info=True; User ID=sa;Password=nando");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-5TIILIC\\NANDO;Initial Catalog=TI_UMY;Persist Security Info=True; User ID=sa;Password=nando");
